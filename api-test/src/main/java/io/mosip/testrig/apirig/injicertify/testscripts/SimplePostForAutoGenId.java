	...
	public void test(TestCaseDTO testCaseDTO)
		...
		if (requestJson.has("credentialId") 
		    ...
		    if (cachedValue == null || cachedValue.isEmpty()) {
		        cachedValue = autoGeneratedIDValueCache
		            .get("GetDataFromLedgerTable_For_LandRegistry_Valid_smoke_Pos_sid_credential_id");
		    }

		    if (cachedValue == null || cachedValue.isEmpty()) {
		        requestJson.put("credentialId", JSONObject.NULL);  // sets key to null
