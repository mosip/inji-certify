...
public class SimplePostForAutoGenId extends InjiCertifyUtil implements ITest {
	...
	public void test(TestCaseDTO testCaseDTO)
		...
		if (requestJson.has("credentialId") || testCaseName.contains("LedgerSearchAPI_ForLandRegistry_Revocation_Flow_all_Valid_Smoke_Sid")) {
			
			String cachedValue = autoGeneratedIDValueCache
					.get("GetDataFromLedgerTable_For_LandRegistry_cred2_Valid_smoke_Pos_sid_credential_id");

			if (cachedValue == null || cachedValue.isEmpty()) {
				requestJson.remove("credentialId");
				requestJson.put("credentialId", JSONObject.NULL);
