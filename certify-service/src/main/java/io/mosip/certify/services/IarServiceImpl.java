...
public class IarServiceImpl implements IarService {
    ...
    private static InteractiveAuthorizationRequest createInteractiveAuthorizationRequest(IarRequest unifiedRequest) {
        InteractiveAuthorizationRequest iarInitialRequest = new InteractiveAuthorizationRequest();
        iarInitialRequest.setResponseType(unifiedRequest.getResponse_type());
        iarInitialRequest.setClientId(unifiedRequest.getClient_id());
        iarInitialRequest.setCodeChallenge(unifiedRequest.getCode_challenge());
        iarInitialRequest.setCodeChallengeMethod(unifiedRequest.getCode_challenge_method());
        iarInitialRequest.setInteractionTypesSupported(unifiedRequest.getInteraction_types_supported());
        iarInitialRequest.setAuthorizationDetails(unifiedRequest.getAuthorization_details());
