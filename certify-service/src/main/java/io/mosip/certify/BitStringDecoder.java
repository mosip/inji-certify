...
public class BitStringDecoder {
    ...
    public static void main(String[] args) throws IOException {
        boolean[] decoded = decodeEncodedList("uH4sIAAAAAAAA_-3YMQ7CMBAEwBBRUPKEPMVPy9OpaACJJOZ8MZ6pIsuRtjlr7WkC_tF1885LYAog3PZhh7O4ZwdgRA5LINTt0F_z82P9VY6TWLIDEKC8LqztM2TwYkI9PRSocKxlUksBoG99nRzmjQ_XTTpQ3lZMM5Xm71sgyJIdYDuPTHWW7AAQqWQHGILKCyNwM4mzZgdgaCU7AFVatTBtDxpSumC3B4p27cUAQAAA", 262144);
        System.out.println("Decoded length: " + decoded.length);
        System.out.println("decoded : "+ decoded[85789]);
